...
const ServicesPage = () => {
    return (
        <>
            <TransitionPage />
            <CircleImage />
            <div className="grid items-center justify-center h-screen max-w-5xl gap-6 mx-auto md:grid-cols-2 mt-20 md:mt-0">
                <div className="max-w-[450px] mt-20 md:mt-0 text-center md:text-left">
                    ...
                    <p className="mb-3 text-xl text-gray-100">Ofrezco servicios como Desarrollador Full Stack y Tester QA.Algunas de las tecnologías más destacables con las que trabajo son: Spring,Angular,React,HTML,CSS,Cypress,Selenium. Aunque estoy deseando aprender y desarrollarme más en el sector!!</p>
